//We're in a job interview. Answer the following questions (try to not look at your notes unless you have to).
  // 1) What is the purpose of the 'this keyword'?
      ...
      //Answer the "this" keyword is used inside functions to replace an objects name. it is very uselful in constructors and callback functions where the object name may be unknown.
  ...
  // 3) What is the difference between call and apply?
      ...
      //Answer call is user inputted for all of the parameters while apply can use an arrqy to fill each of the pararmeters.

  // 4) What does .bind do?

      //Answer it attaches this in a certain function to a particular object.
